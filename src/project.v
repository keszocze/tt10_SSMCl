...
module tt_keszocze_streaming_mult
    ( // Inputs
 ...
 6'b000000,   3'b000,   1'b0};
  wire [1:0] result_2;
  reg [25:0] result_3;
  wire [25:0] c$case_alt_5;
  wire [25:0] c$case_alt_6;
  wire [5:0] c$app_arg;
  wire  c$app_arg_0;
  ...
  assign c$case_alt_0 = ((c$bv[(64'sd0)]) == (1'b1)) ? {{1'b0,
                                                         2'b00,   2'b00},   {1'b1,
                                                                              c$bv_0[0] }} : {{1'b1,
                                                                                               s[3:2] >> (64'sd1),
                                                                                               s[1:0] >> (64'sd1)},
  ...
  assign ds = (({(c$ds_app_arg),((result_12[5:3]))}));
  ...
  assign c$bv_2 = s_0[3:2];

  assign c$bv_3 = (s_0[1:0]);

  assign c$bv_4 = (s_0[1:0]);

  assign c$case_alt_3 = ((c$bv_2[(64'sd0)]) == (1'b1)) ? {{1'b0,
                                                           2'b00,   2'b00},   {1'b1,
                                                                                c$bv_3[0] }} : {{1'b1,
                                                                                                 s_0[3:2] >> (64'sd1),
                                                                                                 s_0[1:0] >> (64'sd1)},
  ...
  assign ds_0 = (({(c$ds_app_arg_0),((result_12[2:0]))}));
  ...
  always @(*) begin
    case(result_selection_1)
      2'b00 : result_3 = c$case_alt_16;
      2'b01 : result_3 = c$case_alt_6;
      2'b10 : result_3 = {{c$app_arg_10,
                           c$app_arg_9,   c$app_arg_8,   c$app_arg_3,
                           c$app_arg_2,   c$app_arg_1,   c$app_arg_0},
                          {1'b0,   1'b0}};
      default : result_3 = c$case_alt_5;
    endcase
  end

  assign c$case_alt_5 = c$case_scrut ? {{2'd0,
                                         3'b000,   3'b000,   {6 {1'b0}},   6'b000000,
                                         3'b000,   1'b0},   {1'b1,   bIn}} : {{2'd3,
                                                                               c$ds_app_arg_1[21:19],
                                                                               c$ds_app_arg_1[18:16],   c$app_arg,
                                                                               c$app_arg_11,   c$ds_app_arg_1[3:1],
                                                                               c$ds_app_arg_1[0:0]},   {1'b1,   bIn}};

  assign c$case_alt_6 = c$case_scrut ? {{2'd2,
  ...
  if (shift_amount == 0) begin : no_shift
    assign c$app_arg = c$vec;
  end else begin : do_shift
    assign c$app_arg = {c$vec[((6-shift_amount)*1)-1 : 0]
  ...
  assign c$app_arg_0 = xDone ? 1'b0 : cOut;

  assign c$app_arg_1 = c$case_scrut ? c$case_alt_7 : c$case_alt_8;

  assign c$case_alt_7 = xDone ? 3'b000 : c$case_alt_8;

  // rotateR begin
  wire [2*3-1:0] bv;
  assign bv = {c$ds_app_arg_1[3:1],c$ds_app_arg_1[3:1]} >> ((64'sd1) % 3);
  assign c$case_alt_8 = bv[3-1 : 0];
  // rotateR end

  assign c$app_arg_2 = c$case_scrut ? c$case_alt_9 : c$case_alt_10;

  assign c$case_alt_9 = xDone ? 6'b100000 : c$ds_app_arg_1[9:4];

  assign c$case_alt_10 = xDone ? c$app_arg_11 : c$ds_app_arg_1[9:4];

  assign c$app_arg_3 = xDone ? c$case_alt_11 : c$case_alt_12;

  assign c$case_alt_11 = c$case_scrut ? c$case_alt_13 : c$case_alt_14;
  ...
  if (shift_amount_0 == 0) begin : no_shift_0
    assign c$case_alt_12 = c$app_arg_6;
  end else begin : do_shift_0
    assign c$case_alt_12 = {c$app_arg_6[((6-shift_amount_0)*1)-1 : 0]
                     ,c$app_arg_6[6-1 : (6-shift_amount_0)*1]
                     };
  end
  endgenerate
  // rotateLeftS end
  ...
  if (shift_amount_1 == 0) begin : no_shift_1
    assign c$case_alt_13 = c$app_arg_4;
  end else begin : do_shift_1
    assign c$case_alt_13 = {c$app_arg_4[((6-shift_amount_1)*1)-1 : 0]
                     ,c$app_arg_4[6-1 : (6-shift_amount_1)*1]
                     };
  end
  endgenerate
  // rotateLeftS end
  ...
  if (shift_amount_2 == 0) begin : no_shift_2
    assign c$case_alt_14 = c$app_arg_4;
  end else begin : do_shift_2
    assign c$case_alt_14 = {c$app_arg_4[(shift_amount_2*1)-1 : 0]
                     ,c$app_arg_4[6-1 : shift_amount_2*1]
                     };
  end
  endgenerate
  // rotateRightS end
  ...
  for (i=0;i<6;i=i+1) begin : vector_replace
    assign c$app_arg_4[(5-i)*1+:1] = (64'sd0) == i ? cOut : c$app_arg_5[(5-i)*1+:1];
  end
  endgenerate
  // vector replace end
  ...
  assign c$app_arg_5 = {c$ds_app_arg_1[14:14],
                        {{c$ds_app_arg_1[13:13],   c$ds_app_arg_1[12:12],   c$ds_app_arg_1[11:11],
                      c$ds_app_arg_1[10:10]},c$app_arg_7}};
  ...
  for (i_0=0;i_0<6;i_0=i_0+1) begin : vector_replace_0
    assign c$app_arg_6[(5-i_0)*1+:1] = (64'sd0) == i_0 ? c$app_arg_7 : c$vec_0[(5-i_0)*1+:1];
  end
  endgenerate
  // vector replace end

  assign c$app_arg_7 = sharedLogic ^ c$ds_app_arg_1[0:0];

  assign c$app_arg_8 = xDone ? (c$ds_app_arg_1[18:16] >> (64'sd1)) : c$ds_app_arg_1[18:16];

  // rotateR begin
  wire [2*3-1:0] bv_0;
  assign bv_0 = {c$ds_app_arg_1[21:19],c$ds_app_arg_1[21:19]} >> ((64'sd1) % 3);
  assign c$app_arg_9 = bv_0[3-1 : 0];
  // rotateR end

  assign c$app_arg_10 = c$case_scrut ? c$case_alt_15 : 2'd2;

  assign c$case_alt_15 = xDone ? 2'd3 : 2'd2;

  assign c$bv_5 = c$ds_app_arg_1[3:1];

  assign xDone = (c$bv_5[(64'sd0)]) == (1'b1);

  assign sharedLogic = aIn ^ bIn;

  assign c$bv_6 = (c$ds_app_arg_1[21:19]);

  assign c$bv_7 = (c$ds_app_arg_1[18:16]);

  assign aIn = ( c$bv_6[0] ) & ( c$bv_7[0] );
  ...
  assign c$bv_8 = c$ds_app_arg_1[9:4];

  assign c$case_scrut = (c$bv_8[(64'sd0)]) == (1'b1);

  assign c$app_arg_11 = c$ds_app_arg_1[9:4] >> (64'sd1);

  assign c$case_alt_16 = start ? {{2'd1,
                                   result_5,   result_4,   c$ds_app_arg_1[15:10],
  ...
  assign result_7 = c$ds_app_arg_2[12:12] ? result_8 : c$case_alt_17;
  ...
  assign c$case_alt_17 = result_2[1:1] ? {{1'b1,
  ...
  assign result_10 = {a1_2 == 1'b1,   b1_2};

  assign ds_1 = (({(c$ds_app_arg_3),(b1_1)}));

  assign a1_1 = result_6[6:6];

  assign b1_1 = result_6[5:0];

  assign a1_2 = ds_1[6:6];

  assign b1_2 = ds_1[5:0];

  assign c$app_arg_12 = result_10[6:6] ? 1'b1 : 1'b0;

  assign result_11 = ({((((c$app_arg_12)))),(({(1'b0),((result_10[5:0]))}))});

  assign c$ds1_case_alt = b;

  assign c$ds2_case_alt = b_0;

  assign result_12 = {a4 == 1'b1,   a3,   a1_3,
                      b1_3};
